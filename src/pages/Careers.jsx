...
// // import CTASection from '../components/CTASection'; // Corrected import path
...
// //   // Image data for the "BULLWORK GALLERY" marquee section (formerly from 'Life' component)
...
// //             </p>
// //             <button
// //               onClick={() => scrollToSection('current-open-positions')} // Scroll to the Apply section
...
// //       {/* Section 3: CURRENT OPEN POSITIONS & MAIL US (Formerly from 'Apply' component) */}
...
//       {/* Section 1: LIFE @ BULLWORK MOBILITY */}
//       <section className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8 lg:py-12">
//         <header className="text-center mb-8 md:mb-12 lg:mb-16">
//           <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight">
//             <br />
...
//       {/* Section 2: JOIN OUR AWESOME TEAM & BULLWORK GALLERY */}
//       <section id="life-at-bullwork" className="bg-white py-12 px-4">
//         <div className="max-w-7xl mx-auto">
//           {/* Join Our Awesome Team */}
//           <div className="text-center mb-12 md:mb-16 lg:mb-20">
//             <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight mb-4">
...
//       <section id="current-open-positions" className="bg-gray-50 py-12 px-4">
//         <div className="max-w-5xl mx-auto">
//           {/* Heading */}
//           <h1 className="text-2xl font-bold text-center mb-10 tracking-widest font-sans ">
//             CURRENT OPEN POSITIONS
